...
import com.gc.googleplay.domain.DownloadInfo;
import com.gc.googleplay.http.HttpHelper;
import com.gc.googleplay.manager.DownloadManager;
import com.gc.googleplay.ui.view.ProgressArc;
...
public class HomeHolder extends BaseHolder<AppInfo> implements DownloadManager.DownloadObserver, View.OnClickListener {
    ...
    public View initView() {
        ...
        // 设置圆形进度条直径
        pbProgress.setArcDiameter(UIUtils.dip2px(29));
        // 设置进度条颜色
